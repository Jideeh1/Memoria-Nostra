...
label start:
    ...
    k "Nah.{w=0.3} Travelers more like."
...
####--------------------------------------DISCONTINUED---------------------------------------------------
    ...
    k "It's fine{w=0.3} really.{w=0.3} You've got a complicated role."
    ...
    k "Cleo is not beating the Chuunibyou allegations."
    ...
    k "Then are we sharing the same dream?{w=1} It still wouldn't make sense."
    k "Everything we experienced already feels so real.{w=0.3} ...Too real."
    c "{sc=2}Oh, man.{w=1} what would Mom say?{/sc}"
    ...
    show text "{glitch=5.0}{size=+100}{i}{font=nud.ttf}CHAPTER 1...{/font}{/size}{w=3}{/i}{/glitch}" at grow_text
    $ quick_menu = False
    pause(2)
    ...
    k "Actually, I wanted to try being a Mage myself{w=0.4}, but like being a warrior isn't half bad." ##insert kurt trying out his sword -- JD
    k "I'm gonna cook so hard with two swords."
    ...
    k "Yeah.{w=0.2} Jokes aside, we should actually come up with a formation based on our best abilities."
    c "Since I am a mage{w=0.3}, I'll stay in the backline."
    c "I'm not good with close combats{w=0.3}, and casting spells take time."
    k "Since I'm peak Kirito--{w=0.2}{nw}" ##insert smug kurt -- JD
    ...
    k "Nahhh, Louise do be backsitting.{w=0.5} Just like his hairline.{nw}" ##his expression is more understandable with this image https://en.meming.world/images/en/1/17/Monkey_Puppet.jpg -- JD
    l "{sc=1}Okay, Kurt.{w=0.5} You were asking for it.{w=0.4} Cleo{w=0.2}, don't give the man any healing potions.{/sc}"
    k "{sc=2}You're not serious, right?{/sc}"
    k "{sc=5}tfff, I was only joking!{/sc}"
    ...
    k "Bro is really not beating any allegations."
    ...
    k "Nah, she seems too busy to eavesdrop."
    ...
    k "Ah, yeah.{w=0.5} I asked the lady earlier and said we could sleep in for free tonight."
    c "Really?{w=0.5} Why?"
    ...
    "We paid for the food and the room we're going to use. The lady instructed us where the room is located."
    ...
    "Hmm."
    k "Well, what if we take on different quests separately.{w=0.3} They're all easy anyway but if we complete three quests,{w=0.3} the pay could cover our expenses. "
    ...
    k "Well, we don't know how long we're staying here so{w=0.3}, we really have all the time in the world to figure out stuff in here."
    l "Aren't you worried?"
    k "..."
    k "Of course I am{w=0.3}, we all are.{w=0.5} Just that, right now{w=0.3} what really matters is what's in front of us."
    ...
    "..."
    #### change bgm, I'll leave it to you JD, you're well-versed with how the audio channel works here better than I do -- Shizo
    "The next morning{w=0.3}, Kurt was the first one to wake up.{w=0.4} Then me and of course AS USUAL, Louise was the last one to wake up."
    "We can't blame Louise for oversleeping though{w=0.3}, it's been a while since we laid on a soft bed."
    ...
    k "Let's review what we talked about last night."
    ...
    "I just hope there's an entertaining backstory to back it up.{w=0.6} Just to amuse me long enough to take on the quest."
    "Kurt probably just says all that but in truth, he just wants to make sure we're all taking easy quests without being in danger."
    l "I guess that wraps it all up."
    k "Yes."
    c "Let's head out then."
    ...
    "I'm trying to find the reason why I was assigned to carry stuff.{w=0.7} But I guess it's because of my physique."
    ...
    "No, wait- Am I lost?"
    "{sc=3}WAIT, IF I'M LOST-{w=0.4} WOULD CLEO AND KURT POST A MISSING DOG POSTER?{/sc}"
    "..."
    ...
    u "Oh... is that so?... I didn't expect someone would actually help an old man over a simple task."
    l "Really? Well, fortunately, me and my friends saw your request and took the chance to help."
    "{i}-and of course to earn money.{/i} Somehow though, my response didn't put the old man at ease."
    ...
    u "I've been using it for years.{w=0.5} It must've been worn-out."
    l "I-I see."
    ...
    l "I'll carry the sacks{w=0.4} while you help me hand it over to the customers."
    u "That{w=0.4}{cps=9}...That{/cps} could actually work.{w=0.5} Are you sure you can endure it?"
    ...
    l "I'm willing to try and find out, sir."

    scene cave with fade
    # Kurt's POV -- Shizo
    
    "I put myself in this situation so I have no qualms about it but..."
    "How should I put this..."
    "I DIDN'T EXPECT IT'D BE THIS DIFFICULT TO GATHER ORES."
    "Usually, in games, ores are easy to gather so long as you have the weapon to hit it."
    "But I guess that's my mistake. Taking everything here as a game. I should've reminded others about that."
    "If we kept on going under the impression of everything in this world is just a game will eventually kill us."
    "Thankfully, our quests are simple for now."
    "Still, getting these ores is harder than I thought it would be."
    u "Having a tough time there, pal?" # This is Eli btw -- Shizo
    "?"
    "I turned around to search for the source of the voice and there stood a petite guy with slit-like eyes."
    "I kept my guard up. I can't just trust anyone here."
    "I could ignore him but I also needed this quest done. I didn't want to be rude too, so I answered."
    k "Y-Yeah."
    u "Hmm."
    u "I see now, you've been doing it wrong!"
    u "You don't have the right tools for it. Using the sword alone would only damage your weapon."
    "Somehow he annoys me."
    u "Fortuntely for you, there's a way to gather ores aside from using pickaxe."
    u "Downside is, it's a lot of work especially for a guy like you."
    k "SO WHICH ONE IS IT? IS IT DOABLE OR NOT?"
    u "Hahaha! Don't worry, I'll help you out."
    "There's no way you'd help someone for free just like that, a strangers out in the wild at that."
    k "I can't bother you to help out a stranger like me. So, I'd like to make it fair and share the rewards with you."
    u "Oho?"
    u "You're too kind! Of course I can't turn down a generous offer like that!"
    k "..."
    "I'm not kind. I'm just being fair. So neither of us would feel indebted to each other."

    scene park with fade
    # Cleo's POV -- Shizo

    "Is there a spell to search for a missing pet?"
    "This town is too huge for me to search alone. I need more lead."
    "Seriously, why does it have to be a missing cat quest. I'd take it if it was farming slimes."
    "But noooo, Kurt said it had to be simple quests first to familiarize ourselves here."
    "Psh, I guess he does have a point."
    "Anyway, back to searching. My only lead right now is this bell."
    "This bell is a tool that the cat only responds to. It doesn't call other cats apparently. What a convenient tool, huh."
    "I wonder, could you call monsters with a bell too?"
    "I had the bell tied to my staff so it'd ring with every stomp while I take a walk around the town."
    "If the information is right, the cat was last seen around this park."
    c "Now, where could you be, you little monster."
    "I rang the bell and waited for a response."
    "Nothing."
    c "This is getting tiring."
    "I'm used to long walks back in our world but somehow my body here isn't acquainted with it."
    "So, I took a seat to catch a breath."
    "The park is packed with children and elderly, most of them are having picnics and kids running around."
    "Some are couples trying to enjoy the view. Some seemed to be writing, maybe drawing?"
    "I felt...alone."
    "I'm glad that Kurt and Louise are with me but I feel bad for dragging them with me."
    "But if it so happens that it was just me in this world. What then?"
    "..."
    "..."
    "..."
    "I miss everyone back home."
    "*clang* *clang*"
    "Come on, Cleo- pick yourself up. No use in thinking about 'what ifs'- and stop blaming yourself!"
    "We're not even sure what was the cause of all this."
    u "Meoooow~"
    c "Huh?"
    "A black cat sat in front of me. Seemingly wanting attention as it was purring and staring at me with eyes that begs."
    "Is this- IS THIS THE MISSING CAT?!"
    c "Hah! Finally caught you!"
    u "Mroooow."
    c "Your owner will be so glad! Y'know what, I'll take you to her right now before you try to run away again."
    "I lifted the cat and carried it all the way back to the owner's house."
